        ...
        <div>
            ...
            {location.loaded ?
                ...
                (<>
                    ...
                    <form>
                        <label><strong><input defaultValue={location.coordinates?.lat.toFixed(4)} /></strong></label>
                        <label><strong><input defaultValue={location.coordinates?.lng.toFixed(4)} /></strong></label>
                    </form>
